...
Magnitude of the parameter estimate on education decreased, as did the standard error around the estimate. If IQ is a good proxy for ability, this does confirm our suspicion that ability is correlated with education.
...
```
Yes, the partial correlation IS statistically significant!
