...
```
The test statistic on v_hat is -1.710, corresponding to a p-value of 0.0873. At a 95% significance level (or even 99% level!) we fail to reject the null hypothesis, thus no evidence of endogeity.
