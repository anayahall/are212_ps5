...
```
The test statistic on v_hat is -1.710, corresponding to a p-value of 0.0873. The critical value for a 95% significance level is $\pm$ 1.96, thus we fail to reject the null hypothesis, finding no significant evidence of endogeneity.
